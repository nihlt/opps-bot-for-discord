...
| `src/lib/summarize.js`, `GEMINI_MODEL`/`GEMINI_API_KEY` | [resilience.md](./resilience.md#the-geminillm-api-doesnt-respond-times-out-or-errors), [assumptions-and-caveats.md](./assumptions-and-caveats.md#gemini_model-value-is-unverified) |
