...
| `src/discord/digest.js` or `src/discord/alerts.js` | [discord-integration.md](./discord-integration.md) — **and check whether "what's wired in" in [architecture.md](./architecture.md) is still accurate** |
| `.github/workflows/daily-digest.yml`, or removing/changing the run-once model in `src/index.js` | [architecture.md](./architecture.md#hosting-github-actions), [resilience.md](./resilience.md), [assumptions-and-caveats.md](./assumptions-and-caveats.md) |
